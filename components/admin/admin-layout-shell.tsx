...
export function AdminLayoutShell({
  ...
  const navItems = [
    ...
    { key: "institutions", name: t("nav.institutions"), href: "/admin/institutions", icon: Building2 },
    ...
    { key: "insights", name: t("nav.insights"), href: "/admin/insights", icon: FileText },
    { key: "posters", name: t("nav.posters"), href: "/admin/posters", icon: ImageIcon },
